    ...
    public partial class ButtonView : UserControl
    {
        ...
        private void UpdateCode()
        {
            ...
            TbCode.Text = "<Button  Height=\"30\"" +
                        ...
                        (buttonStyle == ButtonStyle.Standard ? $"\nBackground=\"{BtnCustom.Background.ToColor().ToHexString(false)}\"" : "") +
                        (buttonStyle == ButtonStyle.Standard ? "" : $"\nBorderBrush=\"{BtnCustom.BorderBrush.ToColor().ToHexString(false)}\"") +
                        (buttonStyle == ButtonStyle.Standard ? "" : $"\nForeground=\"{BtnCustom.Foreground.ToColor().ToHexString(false)}\"") +
