...
{
    public class MessageBoxIconControl : ContentControl
    {
        #region Ctor
        static MessageBoxIconControl()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(MessageBoxIconControl), new FrameworkPropertyMetadata(typeof(MessageBoxIconControl)));
        }
        #endregion
        ...
        public static readonly DependencyProperty InfoBrushProperty =
            DependencyProperty.Register("InfoBrush", typeof(Brush), typeof(MessageBoxIconControl), new PropertyMetadata("#80BEE8".ToColor().ToBrush()));
        #endregion
        ...
        public static readonly DependencyProperty QuestionBrushProperty =
            DependencyProperty.Register("QuestionBrush", typeof(Brush), typeof(MessageBoxIconControl), new PropertyMetadata("#80BEE8".ToColor().ToBrush()));
        #endregion
        ...
        public static readonly DependencyProperty WarningBrushProperty =
            DependencyProperty.Register("WarningBrush", typeof(Brush), typeof(MessageBoxIconControl), new PropertyMetadata("#F9D01A".ToColor().ToBrush()));
        #endregion
        ...
        public static readonly DependencyProperty ErrorBrushProperty =
            DependencyProperty.Register("ErrorBrush", typeof(Brush), typeof(MessageBoxIconControl), new PropertyMetadata("#FF5656".ToColor().ToBrush()));
        #endregion
        ...
        public static readonly DependencyProperty SuccessBrushProperty =
            DependencyProperty.Register("SuccessBrush", typeof(Brush), typeof(MessageBoxIconControl), new PropertyMetadata("#75CD43".ToColor().ToBrush()));
        #endregion
        ...
        public static readonly DependencyProperty InfoIconProperty =
            DependencyProperty.Register("InfoIcon", typeof(string), typeof(MessageBoxIconControl), new PropertyMetadata("\ue92f"));
        #endregion
        ...
        public static readonly DependencyProperty QuestionIconProperty =
            DependencyProperty.Register("QuestionIcon", typeof(string), typeof(MessageBoxIconControl), new PropertyMetadata("\ue937"));
        #endregion
        ...
        public static readonly DependencyProperty WarningIconProperty =
            DependencyProperty.Register("WarningIcon", typeof(string), typeof(MessageBoxIconControl), new PropertyMetadata("\ue931"));
        #endregion
        ...
        public static readonly DependencyProperty ErrorIconProperty =
            DependencyProperty.Register("ErrorIcon", typeof(string), typeof(MessageBoxIconControl), new PropertyMetadata("\ue933"));
        #endregion
        ...
        public static readonly DependencyProperty SuccessIconProperty =
            DependencyProperty.Register("SuccessIcon", typeof(string), typeof(MessageBoxIconControl), new PropertyMetadata("\ue935"));
        #endregion
        ...
        public static readonly DependencyProperty MessageBoxIconProperty =
            DependencyProperty.Register("MessageBoxIcon", typeof(MessageBoxIcon), typeof(MessageBoxIconControl));
        #endregion
