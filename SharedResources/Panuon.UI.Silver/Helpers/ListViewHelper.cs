...
namespace Panuon.UI.Silver
{
    public static class ListViewHelper
    {
        ...
        public static DataGridGridLinesVisibility GetHeaderSeparatorVisibility(ListView listView)
        {
            return (DataGridGridLinesVisibility)listView.GetValue(HeaderSeparatorVisibilityProperty);
        }
        ...
        public static readonly DependencyProperty HeaderSeparatorVisibilityProperty =
            DependencyProperty.RegisterAttached("HeaderSeparatorVisibility", typeof(DataGridGridLinesVisibility), typeof(ListViewHelper));
        #endregion

        #region HeaderVerticalSeparatorBrush
        public static Brush GetHeaderVerticalSeparatorBrush(ListView listView)
        {
            return (Brush)listView.GetValue(HeaderVerticalSeparatorBrushProperty);
        }

        public static void SetHeaderVerticalSeparatorBrush(ListView listView, Brush value)
        {
            listView.SetValue(HeaderVerticalSeparatorBrushProperty, value);
        }

        public static readonly DependencyProperty HeaderVerticalSeparatorBrushProperty =
            DependencyProperty.RegisterAttached("HeaderVerticalSeparatorBrush", typeof(Brush), typeof(ListViewHelper));
        #endregion
        
        #region HeaderHorizontalSeparatorBrush
        public static Brush GetHeaderHorizontalSeparatorBrush(ListView listView)
        {
            return (Brush)listView.GetValue(HeaderHorizontalSeparatorBrushProperty);
        }

        public static void SetHeaderHorizontalSeparatorBrush(ListView listView, Brush value)
        {
            listView.SetValue(HeaderHorizontalSeparatorBrushProperty, value);
        }

        public static readonly DependencyProperty HeaderHorizontalSeparatorBrushProperty =
            DependencyProperty.RegisterAttached("HeaderHorizontalSeparatorBrush", typeof(Brush), typeof(ListViewHelper));
        #endregion
        ...
        #region ItemsWidth
        public static double GetItemsWidth(ListView listView)
        {
            return (double)listView.GetValue(ItemsWidthProperty);
        }

        public static void SetItemsWidth(ListView listView, double value)
        {
            listView.SetValue(ItemsWidthProperty, value);
        }

        public static readonly DependencyProperty ItemsWidthProperty =
            DependencyProperty.RegisterAttached("ItemsWidth", typeof(double), typeof(ListViewHelper));
        #endregion
